...
<html lang="en" dir="ltr">
  ...
  <main>
    <form class="company-form" action="../controllers/formHandling.php" method="post">
      ...
      <input type="text" name="compName" value=<?php echo $bus_instance->businessName; ?>>
      <label for="compDes">Company Description</label>
      <input type="text" name="compDes" value="<?php echo $bus_instance->businessDescription;?>">
      <label for="compLogo">Company Logo</label>
      <input type="file" name="compLogo" value="<?php echo $bus_instance->businessLogo?>" accept="image/*">
      <button type="submit" name="button" value="update-company">submit</button>
    </form>
    <?php
    ?>
  </main>
